...
\begin{tikzpicture}[domain=-2:2]
    ...
    \draw[fill=black] \Point circle (0.05) node[below right] {$\text{Mínimo}$};
\end{tikzpicture}
```
...
\begin{tikzpicture}[domain=-2:2]
    ...
    \draw[fill=black] \Point circle (0.05) node[above right] {$\text{Máximo}$};
\end{tikzpicture}
```
...
\begin{tikzpicture}[domain=-2.2:2.2]
    ...
    \draw[color=lightblue, domain=-2:-1, dotted] plot (\x, \x) node[right]
    \draw[color=lightblue, domain=1:2, dotted] plot (\x, \x) node[right]
    \draw[fill=black] (-1,-1) \Point circle (0.05) node [above] {$\text{Min. Local}$}
    \draw[fill=black] (1,1) \Point circle (0.05) node [above] {$\text{Max. Local}$}
\end{tikzpicture}
```
