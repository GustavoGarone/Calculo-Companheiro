...
*Operação 1.*
No escalonamento, podemos trocar linhas da matriz de lugar.
$$
\begin{bmatrix}
    1 & 2 \\
    3 & 4
...
*Operação 2.*
No escalonamento, podemos multiplicar qualquer linha por um número real $\lambda \neq 0$
$$
\begin{bmatrix}
    1 & 2 \\
    3 & 4
...
*Operação 3.*
No escalonamento, podemos somar linhas e substituílas pelo valor da soma
