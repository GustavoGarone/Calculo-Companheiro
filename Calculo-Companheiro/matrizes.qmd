...
Uma matriz $m \times n$ tem $m$ linhas,a na horizontal, e $n$ colunas, na vertical. Também é comum usarmos $i \times j$, e você pode encontrar essa notação. Chamamos isso de **Ordem** da matriz.
