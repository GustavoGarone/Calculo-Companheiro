...
Sob quais condições a reação tem melhor rendimento?
  ...
  Intuitivamente, é muito fácil compreender o valor de máximo e mínimo de uma função, então vamos definir o que é o máximo
  ...
  o [Teorema de Weierstrass](weierstrass.qmd) não se restringe apenas ao cálculo univariado!
  ...
  é o pico do Monte Everest, mas o topo do [Pico da Neblina](https://pt.wikipedia.org/wiki/Pico_da_Neblina), a 2.995m de altura,
  ...
  localizado 28m abaixo do nível do mar é um mínimo local. Analogamente, qualquer buracos que vemos na rua também é um mínimo local,
  ...
  Da segunda parte, podemos, a partir de uma seleção de pontos críticos, determinar quais são máximo, mínimos e sela. Em resumo,
  ...
  calcularmos em relação a $y$. Tal parte do teorema é "análogo" ao calculo da segunda derivada de uma função de uma variável
